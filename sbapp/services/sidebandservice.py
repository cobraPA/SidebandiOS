...
class SidebandService():
    ...
    def update_connectivity_type(self):
        RNS.log(" DDDDD shared instance update " + str(self.sideband.reticulum.is_connected_to_shared_instance))
    ...
    def get_connectivity_status(self):
        # kjb debug
        RNS.log(" DDDDD shared instance connect check " + str(self.sideband.reticulum.is_connected_to_shared_instance))
        if self.sideband.reticulum.is_connected_to_shared_instance:
