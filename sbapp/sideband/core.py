...
# TODO KJB iOS?
                if RNS.vendor.platformutils.is_android() or RNS.vendor.platformutils.get_platform() == "ios":
...
# KJB TODO - section started with [interfaces] added for testing
# see note about unused on iOS below
rns_config = """
[reticulum]
